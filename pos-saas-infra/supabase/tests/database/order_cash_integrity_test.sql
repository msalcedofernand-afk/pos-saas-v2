...
VALUES ('00000000-0000-0000-0000-000000000104', 'Integrity tests');
INSERT INTO public.products (id, category_id, name, price)
VALUES ('00000000-0000-0000-0000-000000000105', '00000000-0000-0000-0000-000000000104', 'Test product', 10);
INSERT INTO public.tables_restaurant (id, name, status)
VALUES ('00000000-0000-0000-0000-000000000106', 'Test table', 'available');
